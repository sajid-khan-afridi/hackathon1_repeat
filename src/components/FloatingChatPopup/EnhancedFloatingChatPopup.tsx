    ...
    <>
      ...
      >
        ...
        <p id="floating-chat-description" className={styles.visuallyHidden}>
          ...
          citations. Use arrow keys and Tab to navigate, Escape to close.
        </p>
          ...
          <div className={styles.chatContainer}>
            ...
            <div className={styles.botIdentity}>
              ...
              <div className={styles.botIdentityText}>
                ...
                <p>
                  I can help you understand robotics concepts, find relevant modules, explain ROS 2,
                  and answer questions from the textbook. I'll provide answers with source citations
                  when available.
                </p>
                <p className={styles.botIdentityNote}>
                  <strong>What I can't do:</strong> I can't perform calculations, access external
                  resources, or provide real-time data.
                </p>
              </div>
            </div>
